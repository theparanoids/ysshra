...
const (
	...
	NonceCert
	_ // deprecated
	// TouchlessSSHInAgentCert is the certificate which does not require a touch for SSH authentication.
	// TouchlessSSHInAgentCert's private key is backed in SSH-agent.
	TouchlessSSHInAgentCert
...
var TypeLabel = map[Type]string{
	...
	NonceCert:                "Nonce",
	TouchlessSSHInAgentCert:  "TouchlessSSHInAgent",
...
func GetType(cert *ssh.Certificate) Type {
	...
	case k.IsFirefighter && !k.IsHWKey:
		certType = TouchlessSSHInAgentCert
